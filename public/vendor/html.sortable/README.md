...
Use `hoverClass` option to specify applying a css class to the hovered element
...
You do not need to comment on everything you do, but if you make a decision that
